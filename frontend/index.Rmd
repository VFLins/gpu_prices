...
card_left <- card(
    ...
    plot_multiple_prices(entry_available_nvidia_chips, "Greens"),
)
card_right <- card(
...
card_left <- card(
    card_header(card_title(h1("Histórico de preços"))),
    plot_multiple_prices(entry_available_amd_chips, "Reds"),
)
card_right <- card(
    card_header(card_title(h1("Melhores preços atuais"))),
...
card_left <- card(
    card_header(card_title(h1("Histórico de preços"))),
    plot_multiple_prices(entry_available_intel_chips, "Blues"),
)
card_right <- card(
    card_header(card_title(h1("Melhores preços atuais"))),
...
card_left <- card(
    card_header(card_title(h1("Histórico de preços"))),
    plot_multiple_prices(highend_available_nvidia_chips, "Greens"),
)
card_right <- card(
    card_header(card_title(h1("Melhores preços atuais"))),
...
card_left <- card(
    card_header(card_title(h1("Histórico de preços"))),
    plot_multiple_prices(highend_available_amd_chips, "Reds"),
)
card_right <- card(
    card_header(card_title(h1("Melhores preços atuais"))),
