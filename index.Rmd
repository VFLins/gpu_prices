...
```{r pg2-p1-setup}
default_footnote <- "*Fonte de dados de desempenho na página 'SOBRE', **Menor é melhor, Aviso: As recomendações ainda estão em fase experimental"
...
perf_fullpage <- function(title, 
    ...
    card_right <- card(
        ...
        layout_columns(
            fillable=FALSE,
            visual_elements[[1]], visual_elements[[2]], visual_elements[[3]]),
        layout_columns(
            fillable=TRUE,
            visual_elements[[4]]),
